...
const Swap: React.FC = () => {
  ...
  const handleSwap = () => {
    ...
    toast.success('Swap coming soon! 🚀')
  }
  ...
  if (!isConnected) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[70vh] text-center px-4">
        ...
        >
          <div className="w-20 h-20 mx-auto mb-6 rounded-2xl flex items-center justify-center bg-gradient-to-br from-purple-500/20 to-pink-500/20">
          ...
          <p className="text-muted-foreground mb-8">
            Connect your Web3 wallet to swap tokens on XRPL EVM
          </p>
          <motion.button 
            onClick={connectWallet} 
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            className="w-full px-6 py-4 rounded-xl font-bold text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 transition-all shadow-lg"
          >
            Connect Web3 Wallet
          </motion.button>
        </motion.div>
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Swap tokens instantly on XRPL EVM Sidechain • {environment}
        </p>
      </div>
        ...
        >
          ...
          <div>
            ...
            <p className="text-yellow-400/80 text-sm">
              Token swaps are only available on XRPL EVM Sidechain. Please switch networks.
            </p>
          </div>
        </motion.div>
      )}
          ...
          >
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center space-x-2">
                ...
                <input
                  ...
                  className="w-16 px-2 py-1 bg-muted border border-white/10 rounded-lg text-foreground text-sm focus:outline-none focus:border-purple-500/50"
                />
            ...
            <div className="flex justify-center -my-2 relative z-10">
              <button
                ...
                className="p-3 bg-card border-2 border-white/10 hover:border-purple-500/50 rounded-xl transition-all hover:rotate-180 duration-300"
              >
            ...
            {/* Trade Info */}
            <div className="space-y-2 mb-6 p-4 bg-purple-500/5 rounded-xl border border-purple-500/20">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-foreground font-medium">995 DRIPPY</span>
              </div>
            </div>
            ...
            <button
              onClick={handleSwap}
              className="w-full px-6 py-4 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-bold rounded-xl transition-all shadow-lg"
            >
              Swap Tokens
            </button>

            <p className="text-xs text-muted-foreground text-center mt-4">
              ⚠️ DEX integration coming soon. This is a preview interface.
            </p>
          </motion.div>
        </div>
        ...
        <div className="space-y-6">
          ...
          >
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-lg font-semibold text-foreground">Pool Stats</h3>
            </div>
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-green-400">0.00% APY</p>
              </div>
            </div>
          </motion.div>
